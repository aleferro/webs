...
<h1 class="d-flex justify-content-center display-5">List of products</h1>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <img class="card-img-top" src="img/pottery1.jpg" alt="Card image cap">
        <p class="card-text">$50.00</p>
        <a href="product-details.php" class="btn btn-primary">Go somewhere</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
