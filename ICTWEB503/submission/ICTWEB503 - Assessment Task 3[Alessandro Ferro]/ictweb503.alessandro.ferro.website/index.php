			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h1><?php echo _BROWSE_CATALOGUE; ?></h1>
						<p><?php echo _OR_SELECT_CATEGORIES; ?></p>
					</div>
					<div class="col-md-12">
						<div class="row">
								...
								<div class="sm-item isotope-item">
									<div class="product">
										<div class="product-thumb">
											<img src="admin/<?php echo $r['thumb']; ?>" class="img-responsive" width="150px" alt="">
										...
										<div class="product-price"> <?php echo _CURR." ". $r['price']*_EX_RATE; ?><span></span></div>
									</div>
								</div>
							<?php } ?>
